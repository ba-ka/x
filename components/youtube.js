    ...
    render() {
        ...
        return (
            <div className="video-container">
                <YouTube opts={opts} onStateChange={this.onStateChange} onReady={this.onReady}/>
                <div className={`content ${this.state.isPlaying && "show"}`}>
                    ...
                    <div className="logo">
                        <a target="_blank" rel="noreferrer" className={`${!this.state.isPlaying && "transparent"}`} href={`https://youtube.com/watch?v=${this.state.videoData.video_id}`}><h3>[ {this.state.videoData.title} by {this.state.videoData.author} ]</h3></a>
                        <h2>[ ba-ka ] x [ &#12400;-&#12363; ]</h2>
                        <ul>
                            <li><a href="https://ba-ka.org/discord">discord</a></li>
                            <li><a href="https://ba-ka.org/steam">steam</a></li>
